...
HD_PWD='C:/travail/S4APP2/pb_logique_seq/pb_logique_seq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit_tr_signal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circuit_tr_signal.tcl
