...
HD_PWD='C:/travail/S4APP2/pb_logique_seq/pb_logique_seq.runs/design_1_calcul_param_3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_calcul_param_3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_calcul_param_3_0_0.tcl
