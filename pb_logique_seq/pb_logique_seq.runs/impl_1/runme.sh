...
HD_PWD='C:/travail/S4APP2/pb_logique_seq/pb_logique_seq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit_tr_signal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circuit_tr_signal.tcl -notrace
